...
import { ArrowLeft2, Add, BagHappy, TickCircle, ShoppingBag } from 'iconsax-react';
...
export default function ShopPage() {
  ...
  const [activeCategory, setActiveCategory] = useState<'all' | 'dairy' | 'eggs' | 'poultry'>('all');
  ...
  const shopProducts: ShopProduct[] = [
    {
      id: 'shp-1',
      name: '1L Milk & Yogurt',
      description: 'Fresh pasteurized farm cow milk and creamy natural yogurt from Ambo highland farm.',
      category: 'dairy',
      priceETB: 250,
      unit: 'liter',
    ...
    },
    {
      ...
      description: 'Includes 2L pure whole milk + 1kg cultured yogurt + homemade farm butter.',
      category: 'dairy',
      priceETB: 580,
      unit: 'package',
      images: ['/images/fresh_milk_yogurt.png'],
    ...
    },
    {
      ...
      description: 'Locally raised farm chicken, cleaned and ready for holiday cooking.',
      category: 'poultry',
      priceETB: 850,
      unit: 'whole_chicken',
      images: ['/images/fresh_milk_yogurt.png'],
  ...
  const categories = [
    { id: 'all', label: 'ሁሉም', count: shopProducts.length },
    {
      id: 'dairy',
      label: 'ወተትና እርጎ',
  ...
  return (
    <div className="bg-[#f2f4f2] min-h-screen pb-[120px] flex flex-col items-center">
      ...
      {/* Main Content Area */}
      <div className="w-full max-w-[393px] flex flex-col gap-[14px] items-center py-[10px] px-[14px]">
        {/* Category Tabs Switcher */}
        <div className="w-full bg-[#f8fafc] border border-[rgba(226,232,240,0.7)] h-[44px] rounded-[12px] p-[5px] flex items-center justify-between shrink-0 shadow-2xs">
          {categories.map((c) => {
              ...
              >
                <span
                  className={cn(
                    ...
                    isActive ? 'text-white font-semibold' : 'text-[#62748e] font-medium'
                  )}
                >
                  {c.label}
                </span>
                ...
                <div className="p-[10px] flex-1 flex flex-col justify-between gap-[8px]">
                  <div>
                    ...
                    <p className="text-[11px] text-[#868685] line-clamp-1 pt-0.5">
                      {product.unit.replace('_', ' ')} • Ambo Farm
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-1 border-t border-stone-100">
                    <div className="flex items-baseline gap-[2px]">
                      ...
                      <span className="text-[10px] font-bold text-[#163422]">ETB</span>
                    </div>
      ...
      {totalCartCount > 0 && (
        <div className="fixed bottom-[74px] left-0 right-0 max-w-[393px] mx-auto px-[14px] z-40 animate-in slide-in-from-bottom duration-300">
          <Link
            href="/shop/cart"
          ...
          >
            <div className="flex items-center gap-[10px]">
              ...
              <div className="flex flex-col">
                <span className="text-[12px] text-stone-300">Total Cart</span>
