...
export default function ShopPage() {
  ...
  return (
    <div className="bg-[#f2f4f2] min-h-screen pb-[180px] flex flex-col items-center">
      ...
      {/* Sticky Floating Category Tabs Bar */}
      ...
      {totalCartCount > 0 && (
        <div className="fixed bottom-[90px] left-0 right-0 max-w-[430px] mx-auto px-[14px] z-40 animate-in slide-in-from-bottom duration-300">
          <Link
            href="/shop/cart"
