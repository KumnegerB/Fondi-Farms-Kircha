...
export const translations = {
  am: {
    ...
    kircha: {
      ...
      reservationSuccessMsg: 'የ30% ቅድመ ክፍያዎ ተመዝግቧል። በእርድ ቀን ከአምቦ እርሻችን መረከብ ይችላሉ።',
    ...
    // Auth & Onboarding
    auth: {
      loginWithTelegram: 'በቴሌግራም ይግቡ',
      continueWithTelegram: 'በቴሌግራም ቀጥል',
      sharePhoneNumber: 'ስልክ ቁጥሬን አጋራ',
      sharePhoneDesc: 'ትዕዛዝዎን ለማረጋገጥና ለመረከብ ስልክ ቁጥርዎን ያጋሩ ወይም ያስገቡ።',
      phoneInputPlaceholder: '+251 9...',
      confirmAndContinue: 'አረጋግጥና ቀጥል',
      loggingIn: 'በመግባት ላይ...',
      loginSuccess: 'እንኳን ደህና መጡ!',
      loginError: 'መግባት አልተሳካም። እባክዎ እንደገና ይሞክሩ።',
      welcomeTitle: 'ወደ ፎንዲ እርሻ እንኳን ደህና መጡ',
      welcomeSubtitle: 'የበዓል ቅርጫ እና ትኩስ የእርሻ ምርቶች በቀጥታ ከአምቦ',
      changeAccount: 'መለያ ቀይር',
      phoneVerified: 'ስልክ ቁጥር ተረጋግጧል',
      requestingPhone: 'ስልክ ቁጥር በመጠየቅ ላይ...',
      manualPhoneTitle: 'ወይም ስልክ ቁጥርዎን እዚህ ያስገቡ:',
    },
  },
  ...
  en: {
    ...
    kircha: {
      ...
      reservationSuccessMsg: 'Your 30% deposit has been registered. You can collect your beef at Fondi Farms Ambo on slaughter day.',
    ...
    shop: {
      ...
      emptyCartDesc: 'Explore fresh dairy, eggs, and poultry products produced at our Ambo farm.',
      ...
      orderSuccessMsg: 'Your shop order is confirmed for collection at Fondi Farms Ambo.',
    },
    ...
    auth: {
      ...
      sharePhoneNumber: 'Share My Phone Number',
      sharePhoneDesc: 'Share or enter your phone number to confirm and collect your orders.',
      phoneInputPlaceholder: '+251 9...',
      confirmAndContinue: 'Confirm & Continue',
      loggingIn: 'Logging in...',
      loginSuccess: 'Welcome!',
      loginError: 'Login failed. Please try again.',
      welcomeTitle: 'Welcome to Fondi Farms',
      welcomeSubtitle: 'Direct-to-consumer cattle Kircha & fresh farm products from Ambo',
      changeAccount: 'Change Account',
      phoneVerified: 'Phone number verified',
      requestingPhone: 'Requesting phone number...',
      manualPhoneTitle: 'Or enter your phone number here:',
    },
  },
};
